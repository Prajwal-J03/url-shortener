  ...
  return (
    <>
      <div className="w-full h-screen relative bg-gray-50">
        ...
        <p className="absolute bottom-3 right-4">Developed By <a className="text-sky-400 underline underline-offset-3 hover:underline-offset-4 active:text-sky-500">Prajwal J</a></p>
      </div>
    </>
  );
}
